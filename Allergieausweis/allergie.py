...
def fallergien():
    with open ('allergien.csv', newline='') as g:
...
def fland():
    with open ('staaten.csv', newline='') as f:
        reader = csv.reader(f)
...
print('In welchem Land wurde der Allergieausweis mit der Ausweisnummer '+str(n1)+' ausgestellt?')
